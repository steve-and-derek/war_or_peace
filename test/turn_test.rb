...
class TurnTest < Minitest::Test
  ...
  def test_award_spoils_player1_wins_war_turn_type
    card1 = Card.new(:heart, 'Jack', 11)
    card2 = Card.new(:heart, '10', 10)
    card3 = Card.new(:heart, '11', 11)
    card4 = Card.new(:diamond, 'Jack', 11)
    ...
    assert_equal [card8, card1, card2, card6, card3, card4, card5], player1.deck.cards
    assert_equal [card7], player2.deck.cards
    assert_equal [], turn.spoils_of_war
  end

  def test_award_spoils_player2_wins_war_turn_type
    card1 = Card.new(:heart, 'Jack', 11)
    card2 = Card.new(:heart, '10', 10)
    card3 = Card.new(:heart, '11', 11)
    card4 = Card.new(:diamond, 'Jack', 11)
